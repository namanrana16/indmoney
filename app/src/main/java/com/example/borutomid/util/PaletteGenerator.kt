package com.example.borutomid.util
...
object PaletteGenerator {
    ...
    fun extractColorsFromBitmap(bitmap: Bitmap):Map<String,String>
    {
        ...
        return mapOf("vibrant" to parseColorSwatch(color = Palette.from(bitmap).generate().vibrantSwatch),
    ...
    fun parseBodyColor(color: Int?):String{
        ...
        return if(color!=null){val parsedColor=Integer.toHexString(color)
        "#$parsedColor"
        }
        else
        {
